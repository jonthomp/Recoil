...
function getDownstreamNodes(store, state, keys) {
  ...
  for (let key = visitingNodes.pop(); key; key = visitingNodes.pop()) {
    ...
    const subscribedNodes =
      (_store$getGraph$nodeT = store
        .getGraph(state.version)
        .nodeToNodeSubscriptions.get(key)) !== null &&
      _store$getGraph$nodeT !== void 0
        ? _store$getGraph$nodeT
        : emptySet;
...
class MutableSnapshot extends Snapshot {
  constructor(treeState) {
    super({...cloneTreeState(treeState), version: getNextTreeStateVersion$1()});
...
export {
  ...
  Recoil_index_27 as cacheMostRecent,
  Recoil_index_28 as cacheWithReferenceEquality,
  Recoil_index_29 as cacheWithValueEquality,
