...
var Recoil_cacheMostRecent = function () {
  let mostRecentKey, mostRecentValue;
  const cache = {
    get: key => (key === mostRecentKey ? mostRecentValue : void 0),
    set: (key, value) => (
      (mostRecentKey = key), (mostRecentValue = value), cache
    ),
  };
  return cache;
};
...
var Recoil_index = {
  ...
  Recoil_index_27 = Recoil_index.cacheMostRecent,
  Recoil_index_28 = Recoil_index.cacheWithReferenceEquality,
  Recoil_index_29 = Recoil_index.cacheWithValueEquality;
