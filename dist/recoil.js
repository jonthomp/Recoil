(function (global, factory) {
  ...
  function getDownstreamNodes(store, state, keys) {
    ...
    for (let key = visitingNodes.pop(); key; key = visitingNodes.pop()) {
      var _store$getGraph$nodeT;

      dependentNodes.add(key);
      visitedNodes.add(key);
      const subscribedNodes = (_store$getGraph$nodeT = store.getGraph(state.version).nodeToNodeSubscriptions.get(key)) !== null && _store$getGraph$nodeT !== void 0 ? _store$getGraph$nodeT : emptySet;
  ...
  function fireNodeSubscriptions(store, updatedNodes, when) {
    ...
    */
    ...
    const callOrQueue = when === 'enqueue' ? cb => store.getState().queuedComponentCallbacks.push(cb) : cb => cb(state);
    const dependentNodes = getDownstreamNodes(store, state, updatedNodes);

    for (const key of dependentNodes) {
      var _store$getState$nodeT;

      const subscribers = (_store$getState$nodeT = store.getState().nodeToComponentSubscriptions.get(key)) !== null && _store$getState$nodeT !== void 0 ? _store$getState$nodeT : [];
    ...
    resolvers.forEach(cb => callOrQueue(_state => Recoil_Tracing.trace('value became available, waking components', nodeNames, cb)));
  }
    ...
    constructor(treeState) {
      ...
      _defineProperty(this, "getNodes_UNSTABLE", opt => {
        ...
        if ((opt === null || opt === void 0 ? void 0 : opt.dirty) === true) {
          ...
          return Recoil_mapIterable(state.dirtyAtoms, key => Recoil_nullthrows(recoilValues$1.get(key)));
        }
      ...
      _defineProperty(this, "getDeps_UNSTABLE", recoilValue => {
        ...
        const deps = (_storeState$graphsByV = storeState.graphsByVersion.get(storeState.currentTree.version)) === null || _storeState$graphsByV === void 0 ? void 0 : _storeState$graphsByV.nodeDeps.get(recoilValue.key);
        return function* () {
  ...
  class MutableSnapshot extends Snapshot {
    constructor(treeState) {
      super({ ...cloneTreeState(treeState),
        version: getNextTreeStateVersion$1()
      });
    ...
    useEffect$1(() => {
      ...
      Recoil_differenceSets(recoilValuesUsed.current, previousSubscriptions.current).forEach(key => {
        ...
        Recoil_Tracing.trace('initial update on subscribing', key, () => {
          ...
          if (state.nextTree) {
            store.getState().queuedComponentCallbacks.push(Recoil_Tracing.wrap(() => {
  ...
  */
  ...
  const LOADING = {
    recoilDependencyLoadingPlaceholder: null
  };
    ...
    function wrapPendingPromise(store, promise) {
      const wrappedPromise = promise.then(value => {
        ...
        if (((_state$atomValues$get2 = state.atomValues.get(key)) === null || _state$atomValues$get2 === void 0 ? void 0 : _state$atomValues$get2.contents) === wrappedPromise) {
          setRecoilValueLoadable$1(store, node, loadableWithError$2(error));
        }
    ...
    function initAtom(store, initState, trigger) {
      ...
      if (options.effects_UNSTABLE != null) {
        ...
        function setSelf(valueOrUpdater) {
          if (duringInit) {
            const currentValue = initValue instanceof DefaultValue$2 || Recoil_isPromise(initValue) ? options.default : initValue;
        ...
        function onSet(handler) {
          store.subscribeToTransactions(currentStore => {
            ...
            if (newLoadable == null || newLoadable.state === 'hasValue') {
              ...
              const oldValue = oldLoadable == null ? options.default : oldLoadable.state === 'hasValue' ? oldLoadable.contents : DEFAULT_VALUE$4; // TODO This isn't actually valid, use as a placeholder for now.
  ...
  */
  ...
  var Recoil_index = {
    ...
    isRecoilValue: isRecoilValue$5,
    // Caches
    cacheMostRecent: Recoil_cacheMostRecent,
    cacheWithReferenceEquality: Recoil_cacheWithReferenceEquality,
    cacheWithValueEquality: Recoil_cacheWithValueEquality
  };
  ...
  var Recoil_index_27 = Recoil_index.cacheMostRecent;
  var Recoil_index_28 = Recoil_index.cacheWithReferenceEquality;
  var Recoil_index_29 = Recoil_index.cacheWithValueEquality;
  ...
  exports.cacheMostRecent = Recoil_index_27;
  exports.cacheWithReferenceEquality = Recoil_index_28;
  exports.cacheWithValueEquality = Recoil_index_29;
