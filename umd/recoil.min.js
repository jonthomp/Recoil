!(function (global, factory) {
  ...
  var Recoil_FunctionalCore = {
    ...
    getDownstreamNodes: function (store, state, keys) {
  ...
  var Recoil_Graph = {
    ...
    saveDependencyMapToStore: function (dependencyMap, store, version) {
      ...
      })(dependencyMap, store.getGraph(version));
    },
  };
  var Recoil_Tracing = {
          ...
          const newValue = (function (store, {key: key}, valueOrUpdater) {
              if ('function' == typeof valueOrUpdater) {
                ...
                const storeState = store.getState(),
                  ...
                  current = getNodeLoadable$1(store, state, key)[1];
  ...
  var Recoil_RecoilValueInterface = {
    ...
    getRecoilValueAsLoadable: function (
      ...
      const [dependencyMap, loadable] = getNodeLoadable$1(
        store,
        treeState,
        key,
      );
    ...
    markRecoilValueModified: function (store, {key: key}) {
    ...
    setUnvalidatedRecoilValue: function (store, {key: key}, newValue) {
      Recoil_Tracing.trace('set unvalidated persisted atom', key, () =>
        store.replaceState(
          Recoil_Tracing.wrap(state =>
            setUnvalidatedAtomValue$1(state, key, newValue),
          ),
        ),
      );
    },
    ...
    constructor(storeState) {
      _defineProperty(this, '_store', void 0),
        ...
        _defineProperty(this, 'getNodes_UNSTABLE', opt => {
          if (!0 === (null == opt ? void 0 : opt.isModified)) {
            ...
            return recoilValuesForKeys(
              this._store.getState().currentTree.dirtyAtoms,
            );
          }
        ...
        _defineProperty(this, 'getDeps_UNSTABLE', recoilValue => {
          ...
          return recoilValuesForKeys(null != deps ? deps : []);
        }),
        _defineProperty(this, 'getSubscribers_UNSTABLE', ({key: key}) => {
        ...
        _defineProperty(this, 'getInfo_UNSTABLE', recoilValue => {
          ...
          const {key: key} = recoilValue,
            state = this._store.getState().currentTree,
            graph = this._store.getGraph(state.version);
          return {
  ...
  var _useMutableSource,
    Recoil_mergeMaps = function (...maps) {
      const result = new Map();
  ...
  function useRecoilValueLoadable(recoilValue) {
    return useMutableSource && !window.disableRecoilValueMutableSource
      ? (function (recoilValue) {
          const storeRef = useStoreRef$1(),
            getTreeState = useCallback(
            ...
            subscribe = useCallback(
              (_something, callback) => {
                const store = storeRef.current,
                  sub = subscribeToRecoilValue$1(store, recoilValue, () => {
                    Recoil_Tracing.trace(
      ...
      : (function (recoilValue) {
          ...
          return (
            useEffect$1(() => {
              const store = storeRef.current,
                sub = subscribeToRecoilValue$1(store, recoilValue, _state => {
                  Recoil_Tracing.trace(
                    'RecoilValue subscription fired',
                    recoilValue.key,
                    () => {
    ...
    const atomValues = state.atomValues,
      persistedAtomContentsValues = Recoil_mapMap(
        Recoil_filterMap(atomValues, (v, k) => {
          const persistence = getNode$2(k).persistence_UNSTABLE;
          return (
            null != persistence &&
  ...
  const {
    ...
    {AbstractRecoilValue: AbstractRecoilValue$3} = Recoil_RecoilValue$1,
    {
        ...
        cacheKey = cacheKeyFromDepValues(
          new Map(
            Array.from(currentDeps)
              .sort()
              .map(depKey => {
                const [deps, loadable] = getNodeLoadable$2(
                  store,
                  state,
                  depKey,
                );
      ...
      return (
        (function (store, cacheKey, loadable) {
          'loading' !== loadable.state ||
            loadable.contents
              .then(result => {
                const newLoadable = loadableWithValue$1(result);
                return (
              ...
              .catch(error => {
                if (Recoil_isPromise(error)) return error;
    ...
    let defaultLoadable = Recoil_isPromise(options.default)
        ? loadableWithPromise$2(
            options.default
              .then(
                value => (
                  (defaultLoadable = loadableWithValue$2(value)), value
                ),
              )
              .catch(error => {
    ...
    function initAtom(store, initState, trigger) {
      ...
      if (null != options.effects_UNSTABLE) {
        ...
        function setSelf(valueOrUpdater) {
          if (duringInit) {
            const currentValue =
              initValue instanceof DefaultValue$2 || Recoil_isPromise(initValue)
        ...
        function onSet(handler) {
          store.subscribeToTransactions(currentStore => {
            ...
            if (null == newLoadable || 'hasValue' === newLoadable.state) {
              ...
              const newValue =
                  null != newLoadable ? newLoadable.contents : DEFAULT_VALUE$4,
                oldLoadable =
                  null !==
    ...
    const node = registerNode$2({
      ...
      get: function (store, state) {
        ...
        if (state.nonvalidatedAtoms.has(key)) {
          ...
          if (null == persistence) return [new Map(), defaultLoadable];
          const nonvalidatedValue = state.nonvalidatedAtoms.get(key),
            ...
            validatedValueLoadable =
              validatorResult instanceof DefaultValue$2
                ? defaultLoadable
                : loadableWithValue$2(validatorResult);
          return (
  ...
  var Recoil_cacheWithValueEquality = function () {
    const map = new Map(),
      cache = {
        ...
        set: (key, value) => (
          map.set(Recoil_stableStringify(key), value), cache
        ),
        map: map,
      };
    return cache;
